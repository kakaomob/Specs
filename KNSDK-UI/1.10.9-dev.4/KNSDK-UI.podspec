...
Pod::Spec.new do |s|
  s.name          = "KNSDK-UI"
  s.version       = "1.10.9-dev.4"
  s.summary       = "KakaoNaviSDK"
  s.description   = "KakaoNaviSDK for iOS. Inhouse use only, 23082004"
  ...
  s.source           = { :http => "https://devrepo.kakaomobility.com/repository/kakao-mobility-ios-knsdk-release/1.10.9-dev.4/KNSDK-UI/KNSDK.xcframework.zip", :type => "zip" }
